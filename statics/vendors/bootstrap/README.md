...
[![CSS gzip size](https://img.badgesize.io/twbs/bootstrap/v4-dev/dist/statics/css/bootstrap.min.css?compression=gzip&label=CSS+gzip+size)](https://github.com/twbs/bootstrap/tree/v4-dev/dist/statics/css/bootstrap.min.css)
[![JS gzip size](https://img.badgesize.io/twbs/bootstrap/v4-dev/dist/statics/js/bootstrap.min.js?compression=gzip&label=JS+gzip+size)](https://github.com/twbs/bootstrap/tree/v4-dev/dist/statics/js/bootstrap.min.js)
...
Documentation search is powered by [Algolia's DocSearch](https://community.algolia.com/docsearch/). Working on our search? Be sure to set `debug: true` in `site/docs/4.3/assets/statics/js/src/search.js` file.
...
Moreover, if your pull request contains JavaScript patches or features, you must include [relevant unit tests](https://github.com/twbs/bootstrap/tree/master/statics/js/tests). All HTML and CSS should conform to the [Code Guide](https://github.com/mdo/code-guide), maintained by [Mark Otto](https://github.com/mdo).
...
<a href="https://www.browserstack.com/">
  <img src="https://live.browserstack.com/../statics/images/admin_panel/opensource/browserstack-logo.svg" alt="BrowserStack Logo" width="192" height="42">
</a>
